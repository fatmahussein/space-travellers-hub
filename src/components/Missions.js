...
import { getMissions, reserveMission } from '../Redux/MissionSlice'; // Import the action
          ...
          {missions.length > 0 ? (
            missions.map((mission) => (
              <tr key={mission.mission_id}>
                ...
                <td>
                  <button type="button" className="joinBtn" onClick={() => handleMissionAction(mission.mission_id)}>
